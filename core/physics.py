    ...
    for i, ball in enumerate(balls):
        ...
        if ball.in_flight:
            ...
            if ball.pos[0] < margin:
                ball.pos[0] = margin
                ball.vel[0] *= -0.5
            elif ball.pos[0] > world_w - margin:
                ball.pos[0] = world_w - margin
                ball.vel[0] *= -0.5
            if ball.pos[1] < margin:
                ball.pos[1] = margin
                ball.vel[1] *= -0.5
            elif ball.pos[1] > world_h - margin:
                ball.pos[1] = world_h - margin
                ball.vel[1] *= -0.5
            continue
        ...
        if ball.moving:
            ...
            if speed < config.STOP_THRESHOLD:
                ...
                if ball.pos[0] < config.MARGIN:
                    ...
                    ball.vel[0] *= -0.5
                elif ball.pos[0] > config.WORLD_WIDTH - config.MARGIN:
                    ball.pos[0] = config.WORLD_WIDTH - config.MARGIN
                    ball.vel[0] *= -0.5
                if ball.pos[1] < config.MARGIN:
                    ball.pos[1] = config.MARGIN
                    ball.vel[1] *= -0.5
                elif ball.pos[1] > config.WORLD_HEIGHT - config.MARGIN:
                    ball.pos[1] = config.WORLD_HEIGHT - config.MARGIN
                    ball.vel[1] *= -0.5
