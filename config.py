...
# Размеры экрана (задаются в main.py перед запуском игры)
SCREEN_WIDTH = 0
SCREEN_HEIGHT = 0
FPS = 60
...
GRAVITY = 600.0  # пикселей/с²
MIN_ANGLE = 0  # минимальный угол (0° – удар строго вперёд, без подъёма)
MAX_ANGLE = 70  # максимальный угол возвышения (градусы)
ANGLE_SELECT_RADIUS = 40  # радиус круга на мяче для выбора точки удара
